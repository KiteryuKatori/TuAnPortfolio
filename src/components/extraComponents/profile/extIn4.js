    ...
    return (
        <div id="extraInfo">
            ...
            <div className="wrapper">
                ...
                <p><span className="spaces">___</span>Trying to pass the National Highschool Exam in Viet Nam makes me tired and stressed out. So I started to find something else to relax. First thought, well, of course it's gonna be video games, but not for long. Soon after that, I went back on the track and started learning <span className="skill">HTML, CSS and Javascript</span> as a way to ease my mind. And as a result, I am capable of summoning web elements by stuffing colorful lines of weird texts into packs of files, then do a little magic and *puff*, a little webpage just appeared out of nowhere.</p>
